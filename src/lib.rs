...
//! - [`render::RenderDatom`] — the Datom-fallback renderer (the
...
/// The criome access level the daemon mirrors into canonical state.
...
pub use render::{RenderDatom, RenderOrigin, RenderedObject};
